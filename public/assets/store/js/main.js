...
for (let i = 0; i < dropdownTitles.length; i++) {
    dropdownTitles[i].addEventListener("mouseenter", () => {
        dropdownTitles[i].style.color = "#4fbcc9";
    });

    dropdownTitles[i].addEventListener("mouseleave", () => {
        dropdownTitles[i].style.color = ""; // Rétablit la couleur d'origine
    });
}
